	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1>Visualisar Tipo de Equipamento</h1>
					</div>
					<div class="col-sm-6">
			...
			<div class="container-fluid">
				...
				<div class="card card-secondary card-outline">
								...
								<div class="form-group">
								  <label>#ID:</label>
									<div class="input-group">
										...
										<input type="text" DISABLED class="form-control" value="<?=$rs->fld("tipo_id");?>"/>
									 </div>
								</div>
								<!-- /.form-group -->
							</div>						
					...
					<div class="card-footer">
						...
						<a class='btn btn-sm btn-info' data-toggle='tooltip' data-placement='bottom' title='Novo Tipo' href="eq_cad_tipo.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Novo</a>
						<a class='btn btn-sm btn-info' data-toggle='tooltip' data-placement='bottom' title='Alterar Tipo'  href="eq_edit_tipo.php?token=<?=$_SESSION['token']?>&acao=N&tipoid=<?=$rs->fld('tipo_id');?>"><i class="fas fa-edit"></i></i> Editar</a>
					</div>
				  <!-- /.col (right) -->
				</div>
				<!-- /.row -->
