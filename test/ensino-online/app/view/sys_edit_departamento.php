			...
			<div class="container-fluid">				
				<div class="card card-secondary card-outline">
									...
									<div class="form-group">
									  <label>#Nome:</label>
										<div class="input-group">
											...
											<input type="text" class="form-control" maxlength="30" name="dp_nome" id="dp_nome" value="<?=$rs->fld("dp_nome");?>">
										</div>
									</div>
								    <!-- /.form-group -->
								</div>							            
					...
					<div class="card-footer">							
						<button type="button" id="btn_Editdp" class="btn btn-sm btn-info" type="submit"><i class="fas fa-sync-alt"></i> Alterar</button>							
