		...
		<section class="content">
			<div class="container-fluid">				
				<div class="card card-secondary card-outline">
					...
					<!-- /.card-header -->
					<div class="card-body">
						<form role="form" id="FormCadMarca">  
							<div class="row">
								<div class="col-sm-5">
									<div class="form-group">
									  <label for="emp_nome">#Tipo:</label>
										<div class="input-group">
											<div class="input-group-prepend">
											  <span class="input-group-text"><i class="fas fa-server"></i></span>
											</div>
											<select class="form-control select2bs4" id="marc_tipoId" name="marc_tipoId"/>
												<option value="">Selecione...</option> 
												<?php													
												$rs->Seleciona("*","eq_tipo", "tipo_id<>0");
												while($rs->GeraDados()){ ?>
								...
								<div class="col-sm-3">
									<div class="form-group">
									  <label for="dp_nome">#Marca:</label>
										<div class="input-group">
											<div class="input-group-prepend">
											  <span class="input-group-text"><i class="fas fa-apple-alt"></i></span>
											</div>
											<input type="text"  class="form-control"  id="marc_nome" maxlength="20" name="marc_nome"  placeholder="Desc. do Marca"/>
										</div>
									</div>
									<!-- /.form-group -->
								</div>
					...
					<div class="card-footer">					
						<button type="button" id="btn_CadMarca" class="btn btn-info btn-sm" type="submit"><i class="fas fa-save"></i> Salvar</button>
