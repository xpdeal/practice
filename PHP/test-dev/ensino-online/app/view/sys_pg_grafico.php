				...
				<div class="row mb-2">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">In LINE</li>	
						</ol>
					</div>
				</div>
			</div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Eventos por mes</h3>
...
<script>
  $(function () {
      ...
      datasets: [
        {
          ...
          pointRadius         : false,
          pointColor          : '#19692c',
          pointStrokeColor    : 'rgba(255, 255, 0)',
          pointHighlightFill  : '#fff',
          pointHighlightStroke: 'rgba(255, 255, 0)',
          data                : [<?=$jan_ev2;?>, <?=$fev_ev2;?>, <?=$mar_ev2;?>, <?=$abr_ev2;?>, <?=$mai_ev2;?>, <?=$jun_ev2;?>, <?=$jul_ev2;?>]
        },
		{
          label               : 'Evento 1',
          ...
          data                : [<?=$jan_ev1;?>, <?=$fev_ev1;?>, <?=$mar_ev1;?>, <?=$abr_ev1;?>, <?=$mai_ev1;?>, <?=$jun_ev1;?>, <?=$jul_ev1;?>]
        },		
        {
          ...
          data                : [<?=$jan_ev;?>, <?=$fev_ev;?>, <?=$mar_ev;?>, <?=$abr_ev;?>, <?=$mai_ev;?>, <?=$jun_ev;?>, <?=$jul_ev;?>]
        },
      ]
    }
    ...
    var donutData        = {
      ...
      datasets: [
        {
          data: [<?=$departamentos;?>,<?=$usuarios;?>,<?=$empresa_local;?>,<?=$equipamentos;?>],
