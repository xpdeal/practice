		...
		<section class="content">
			<div class="container-fluid">				
				<div class="card card-secondary card-outline">
					...
					<!-- /.card-header -->
					<div class="card-body" >
						<form role="form" id="FormEditMarca">  
							<div class="row">							
								<div class="col-sm-1">
									...
									<div class="form-group">
									  <label>#Marca:</label>
										<div class="input-group">
											...
											<input type="text" class="form-control" name="marc_nome" id="marc_nome" maxlength="20" value="<?=$rs->fld("marc_nome");?>"/>
										</div>
									</div>
								    <!-- /.form-group -->
								</div>
					...
					<div class="card-footer">							
						<button type="button" id="btn_EditMarca" class="btn btn-sm btn-info" type="submit"><i class="fas fa-sync-alt"></i> Alterar</button>							
