...
class functions extends recordset{
	...
	function is_set($variavel){//Verifica se est� setado e se valor != null
    ...
    /**
     * Calcula a diferen�a em horas comerciais entre a primeira e a segunda data passadas como par�metro
     * @param DateTime $data1 Data inicial
     * @param DateTime $data2 Data final
     * @param DateTime $inicio Hora de inicio do hor�rio comercial, padr�o = 8
     * @param DateTime $fim Hora de t�rmino do hor�rio comercial, padr�o = 18
    ...
    public static function horasUteis(DateTime $start, DateTime $end, $feriados = Array(), $inicio = '7:30', $fim = '17:00') {
        ...
        while ($step <= $end) {
            ...
            if (($step->format('U') < $hora_fim)&&($step->format("w")!=0) || ($step->format("w")!=6)) {
                ...
                // Se a hora estiver abaixo do hor�rio comercial
