            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="container">
                            <?php
                                $result = file_get_contents("http://192.168.0.37:3001/atendimentos");
                                $atendimento = json_decode($result);
                            ?>
                            <table class="table">
                                <thead class="text-center text-sm text-gray-500 sm:text-left">
                                    <tr>
                                        <th>ID</th>
                                        <th>Cliente</th>
                                        <th>Pet</th>
                                ...
                                <tbody class="text-center text-sm text-gray-500 sm:text-left">
